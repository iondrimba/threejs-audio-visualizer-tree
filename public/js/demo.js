  ...
  _createClass(App, [{
    ...
    value: function complete(file) {
      ...
      setTimeout(function () {
        ...
        _this3.createRingOfSquares(20, 4, 0x2b9454, _this3.rings, -4);
        _this3.createRingOfSquares(18, 3.5, 0x2b9454, _this3.rings, -2);
        _this3.createRingOfSquares(16, 3, 0x2b9454, _this3.rings, 0);
        _this3.createRingOfSquares(14, 2.5, 0x2b9454, _this3.rings, 2);
        _this3.createRingOfSquares(10, 2, 0x2b9454, _this3.rings, 4);
        _this3.createRingOfSquares(6, 1.5, 0x2b9454, _this3.rings, 6);
        _this3.createRingOfSquares(4, 1.2, 0x2b9454, _this3.rings, 8);
        _this3.createRingOfSquares(3, .8, 0x2b9454, _this3.rings, 10);
        _this3.createRingOfSquares(2, .4, 0x2b9454, _this3.rings, 12);
        _this3.createRingOfSquares(1, 0, 0x2b9454, _this3.rings, 14);
    ...
    value: function createRingOfSquares(count, radius, color, rings, posY) {
    ...
    value: function addSpotLight() {
      var spotLight = new THREE.SpotLight(0x2b9454);
    ...
    value: function addAmbientLight() {
      var light = new THREE.AmbientLight(0x2b9454);
    ...
    value: function drawWave() {
      if (this.playing) {
        ...
        for (var i = 0; i < this.rings.length; i++) {
          ...
          _gsap.TweenMax.to(s.position, .1, {
            y: delta
          });
        }
        ...
        for (var j = 0; j < this.objects.length; j++) {
          ...
          _gsap.TweenMax.to(s1.scale, .1, {
            x: delta1,
            y: delta1,
            z: delta1
          });

          _gsap.TweenMax.to(s1.position, .1, {
